...
import lildude from '../../public/images/LittleDude.png';
...
export { background2024, backgroundNav, bullet, bulletExpand, heart, discord, instagram, linkedin, tiktok, lildude, littlestGuy, picklogo24, stars };
